...
const Banner = () => {
    ...
    return (
        <div className="relative">
            ...
            <div className="w-full h-screen absolute z-20 top-0 bg-black opacity-85">
                <div className='flex flex-col justify-center items-center h-full text-slate-200'>
                    <div className='border-l-4 border-orange-500 pl-5'>
                        <h1 className='lg:text-4xl text-2xl font-bold'>Muhammad Jahirul Islam</h1>
                        <h4 className='lg:text-xl  py-4'>Entrepreneur <span className='text-orange-500'>|</span> Teacher <span className='text-orange-500'>|</span> Author</h4>
